...
# Train the model
model.fit(x_training, y_training, epochs=100, batch_size=32, validation_data=(x_testing, y_testing))

# Evaluate the model
model.evaluate(x_testing, y_testing, verbose=2)

# Function to predict opening
...
# Change new_moves to new chess move
new_moves = "d4 d5 c4 Nc6 cxd5 Qxd5 e3 e5 Nc3 Bb4 Bd2 Bxc3 Bxc3 exd4 Ne2"
